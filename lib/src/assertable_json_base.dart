...
abstract class AssertableJsonBase with InteractionMixin {
  ...
  // Assert that a String, List, or Map is empty
  /// Asserts that the value at the specified [path] is empty.
  ///
  /// The value can be a [String], a [List] (array), or a [Map]. If the value is not
  /// empty or is not one of these types, the assertion fails.
  ///
  /// If [path] is not provided, the assertion is performed on the root JSON data.
