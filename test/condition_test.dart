...
void main() {
  group('ConditionMixin', () {
    ...
    test('isGreaterThan validates numeric comparisons', () {
      ...
      expect(() => json.isGreaterThan('age', 30), throwsA(isA<TestFailure>()));
    });
    ...
    test('isLessThan validates numeric comparisons', () {
      ...
      expect(() => json.isLessThan('age', 20), throwsA(isA<TestFailure>()));
    });
    ...
    test('isLessOrEqual validates inclusive comparisons', () {
      ...
      expect(() => json.isLessOrEqual('age', 24), throwsA(isA<TestFailure>()));
    });
    ...
    test('equals validates exact numeric equality', () {
      ...
      expect(() => json.equals('age', 26), throwsA(isA<TestFailure>()));
    });
    ...
    test('notEquals validates numeric inequality', () {
      ...
      expect(() => json.notEquals('age', 25), throwsA(isA<TestFailure>()));
    });
    ...
    test('isDivisibleBy validates division without remainder', () {
      ...
      expect(() => json.isDivisibleBy('count', 7), throwsA(isA<TestFailure>()));
    });
    ...
    test('isMultipleOf validates multiplication factors', () {
      ...
      expect(() => json.isMultipleOf('count', 7), throwsA(isA<TestFailure>()));
    });
    ...
    test('isBetween validates numeric ranges', () {
      ...
      expect(() => json.isBetween('age', 26, 30), throwsA(isA<TestFailure>()));
    });
    ...
    test('isPositive validates positive numbers', () {
      ...
      expect(() => json.isPositive('temperature'), throwsA(isA<TestFailure>()));
    });

    test('isNegative validates negative numbers', () {
      json.isNegative('temperature');

      expect(() => json.isNegative('age'), throwsA(isA<TestFailure>()));
    });
